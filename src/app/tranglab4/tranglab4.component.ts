...
@Component({
  selector: 'app-tranglab4',
  templateUrl: './tranglab4.component.html',
  styleUrls: ['./tranglab4.component.css']
})
export class Tranglab4Component implements OnInit {
  title=Tranglab4Component;
  list = [
    {
        "name": "Aniseed Syrup",
        "price": 190,
  ...
  nextPage()
  {
    if(this.list.length/this.rowonpage>this.page)
    this.page++;
  }
  prePage()
  {
